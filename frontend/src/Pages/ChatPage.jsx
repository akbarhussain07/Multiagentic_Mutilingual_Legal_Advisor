...
//                 <span></span>
//               </div>
//               <p className="thinking-text">Legal Advisor is thinking...</p>
//             </div>
//           </div>
//         </div>
//       )}
...
export default function ChatPage() {
  ...
  return (
    <div className="chat-page-container">
      ...
      <aside className={`sidebar ${!sidebarOpen ? "closed" : ""}`}>
        <div className="sidebar-header">
          <button className="new-chat-btn" onClick={() => { handleNewChat(); if (isMobile) setSidebarOpen(false); }}>
            <Plus size={20} />
            New Chat
          </button>
        </div>
        ...
        <header className="chat-header">
          ...
          >
            {backendStatus === "connected" ? (
              <>
                <CheckCircle size={16} color="#10b981" />
                <span className="status-text" style={{ fontSize: "14px", color: "#10b981" }}>
                  Connected
                </span>
              </>
            ) : backendStatus === "disconnected" ? (
              <>
                <AlertCircle size={16} color="#ef4444" />
                <span className="status-text" style={{ fontSize: "14px", color: "#ef4444" }}>
                  Offline
                </span>
              </>
            ) : (
              <>
                <Loader2 size={16} color="#f59e0b" className="spinner" />
                <span className="status-text" style={{ fontSize: "14px", color: "#f59e0b" }}>
                  Connecting...
                </span>
              </>
            )}
